...
import test.SpellCheckerStub;

/**
 * Integration test with spell checking against a second deployment, which stubs the spell checker
 * with a simple {@link WebServlet}.
 * 
 * @see SpellCheckerStub
 */
@RunWith(Arquillian.class)
public class TodoResourceStubIT {
  ...
  @Test
  @RunAsClient
  public void testCreateWithSpellCheckerServletStub() {
    ...
    assertThat(actual.getDescription(), equalTo(String.format("%s (spell checked by stub)", todo.getDescription())));
  }
}
